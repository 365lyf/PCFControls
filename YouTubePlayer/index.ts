...
export class YoutubePlayer implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	public init(context: ComponentFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, container:HTMLDivElement)
	{
		...
		this.videoIFrame.setAttribute("id", "video");
		this.videoIFrame.setAttribute("class", "videoplayerframe");

	
	//	this.divContainer.appendChild(this.inputField);
		this.divContainer.appendChild(this.videoIFrame);
